...
{
  private static final long serialVersionUID = 1408043418215220939L;

  public static final double DEFAULT_POLARIZATION = 0.5D;

  @SuppressWarnings("FieldCanBeLocal")
  private static final String EXTRAS_FORMAT = "(%1$s, a=%2$1.3f, e=%3$1.3f)";
  ...
  public String toString()
  {
    synchronized (this)
    {
      ...
      return String.format(EXTRAS_FORMAT, sb.toString(), this.atomicity, this.expectation);
    }
  }
