...
{
  private static final long serialVersionUID = -3412417783192584705L;

  @SuppressWarnings("FieldCanBeLocal")
  private static final String TO_STRING_FORMAT = "(r=%1$1.3f, s=%2$1.3f, a=%3$1.3f, e=%4$1.3f)";
  ...
  public static final List<PureBayesian> normalize(Collection<? extends PureBayesian> opinions)
  {
    ...
    List<PureBayesian> newOpinions = new ArrayList<>();
  ...
  {
    return toSubjectiveOpinion().discountBy(y).toPureBayesian();
  }
  ...
  public void setAtomicity(double atomicity)
  {
    ...
    this.changeSupport.firePropertyChange("atomicity", old, atomicity);
  }
  ...
  public String toString()
  {
    ...
    {
      setDependants();
      return String.format(TO_STRING_FORMAT, this.positive, this.negative, this.atomicity, getExpectation());
    }
  }
